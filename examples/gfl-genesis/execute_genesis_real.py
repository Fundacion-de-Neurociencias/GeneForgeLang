    ...
    for cycle in range(1, 6):
        ...
        for i in range(10):
            ...
            candidate["combined_score"] = (
                candidate["on_target_score"] * 0.6 + 
                (1 - candidate["off_target_score"]) * 0.4
            )
...
def generate_manuscript_table():
    ...
    table1 = df.head(10)[['id', 'sequence', 'combined_score', 'on_target_score', 'off_target_score', 'efficiency_confidence']].copy()
    table1.columns = ['Candidate ID', 'gRNA Sequence', 'Combined Score', 'On-Target Score', 'Off-Target Score', 'Efficiency Confidence']
