# geneforge_app/execution_components/data_staging_manager.py
...
class DataStagingManager:
    ...
    def _download_file_from_signed_url(self, signed_url: str, destination: Path) -> None:
        """
        Download a file from a signed URL to a local destination using Google Cloud Storage client.
    ...
    def cleanup(self) -> None:
        ...
        if self.temp_dir and self.temp_dir.exists():
            ...
            logger.info("No temporary directory to clean up")# geneforge_app/execution_components/data_staging_manager.py
# DataStagingManager for handling file downloads and parameter resolution before plugin execution
