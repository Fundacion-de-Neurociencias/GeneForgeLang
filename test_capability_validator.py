...
from gfl.capability_system import EngineCapabilityChecker, GFLFeature, get_engine_capabilities
    ...
    for engine_type in engine_types:
        ...
        try:
            ...
            validator = EnhancedSemanticValidator(
                file_path="test_spatial_genomic.gfl", engine_capabilities=capabilities
            )
