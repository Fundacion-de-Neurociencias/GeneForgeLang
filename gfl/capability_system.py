...
class GFLFeature(Enum):
    ...
    METABOLITES_BLOCK = "metabolites_block"
...
class GFLValidationWarning:
    ...
    def __init__(self, message: str, feature: Optional[GFLFeature] = None, suggestion: Optional[str] = None):
...
class GFLValidationResult:
    ...
    def add_warning(
        self, message: str, feature: Optional[GFLFeature] = None, suggestion: Optional[str] = None
...
CAPABILITY_DEFINITIONS: dict[GFLFeature, CapabilityInfo] = {
    ...
    GFLFeature.TRANSCRIPTS_BLOCK: CapabilityInfo(
        feature=GFLFeature.TRANSCRIPTS_BLOCK,
        name="Transcripts Block",
        description="Transcript definition and management capabilities",
        version_introduced="v2.0.0",
        dependencies=[],
        is_experimental=False,
    ),
    GFLFeature.PROTEINS_BLOCK: CapabilityInfo(
        feature=GFLFeature.PROTEINS_BLOCK,
        name="Proteins Block",
        description="Protein definition and domain annotation capabilities",
        version_introduced="v2.0.0",
        dependencies=[GFLFeature.TRANSCRIPTS_BLOCK],
        is_experimental=False,
    ),
    GFLFeature.METABOLITES_BLOCK: CapabilityInfo(
        feature=GFLFeature.METABOLITES_BLOCK,
        name="Metabolites Block",
        description="Metabolite definition and chemical formula capabilities",
        version_introduced="v2.0.0",
        dependencies=[],
        is_experimental=False,
    ),
    GFLFeature.EXTERNAL_IDENTIFIERS: CapabilityInfo(
        feature=GFLFeature.EXTERNAL_IDENTIFIERS,
        name="External Identifiers",
        description="Integration with external biological databases",
        version_introduced="v2.0.0",
        dependencies=[],
        is_experimental=False,
    ),
...
def create_engine_capability_sets() -> dict[str, set[GFLFeature]]:
    ...
    return {
        ...
        "advanced": {
            ...
            GFLFeature.TRANSCRIPTS_BLOCK,
            GFLFeature.PROTEINS_BLOCK,
            GFLFeature.METABOLITES_BLOCK,
            GFLFeature.EXTERNAL_IDENTIFIERS,
        },
