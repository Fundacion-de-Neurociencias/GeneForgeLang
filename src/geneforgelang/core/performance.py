...
class LazyLoader(Generic[T]):
    ...
    def __init__(self, loader_func: Callable[[], T], cache_key: str | None = None):
...
class PerformanceOptimizer:
    ...
    def get_cache(self, name: str) -> IntelligentCache | None:
    ...
    def get_cache_stats(self) -> dict[str, CacheStats | None]:
