...
class ModelComparisonRequest(BaseModel):
    ...
    model_names: list[str] | None = Field(default=None, description="Specific models to compare")
    ...
    try:
        ...
        return create_success_response(
            data={
                ...
                "message": (
                    "Workflow queued for execution" if not gfl_request.dry_run else "Dry run validation passed"
                ),
            },
