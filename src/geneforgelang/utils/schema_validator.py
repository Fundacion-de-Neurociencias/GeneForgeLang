...
from geneforgelang.core.gftypes import ValidationError, ValidationResult
...
def validate_with_schema(data: dict[str, Any], schema: dict[str, Any] | None = None) -> ValidationResult:
