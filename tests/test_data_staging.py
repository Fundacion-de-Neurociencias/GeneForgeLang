...
class TestDataStagingManager:
    ...
    def test_stage_files_no_manifest(self):
        ...
        plugin_params = {"input_file": "sample.sam", "threads": 4}
    ...
    def test_stage_files_no_matching_files(self):
        ...
        plugin_params = {"input_file": "nonexistent.sam", "threads": 4}

        data_manifest = {"other.sam": "https://example.com/other.sam"}
    ...
    def test_stage_files_download_failure(self):
        ...
        data_manifest = {"sample.sam": "https://example.com/sample.sam"}
...
class TestDataStagingIntegration:
    ...
    def test_gfl_service_integration(self):
        ...
        request = ExecuteRequest(ast=ast, context={}, data_manifest=data_manifest)
